...
#endif /* !CONFIG_MPSL_USE_EXTERNAL_CLOCK_CONTROL */
	/* mpsl_pan_rfu() was removed from the MPSL API in nrfxlib v3.4.0
	 * (sdk-nrf v3.4.0 no longer calls it); CONSTLAT is handled by the
	 * SoC-level CONFIG_SOC_NRF_FORCE_CONSTLAT setting alone.
	 */
